...
class OfferTeamPlayerList extends GetView<OfferListTeamPlayerController> {
  static const routeName = '/teams/offers/player';
  const OfferTeamPlayerList({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(OfferListTeamPlayerController());

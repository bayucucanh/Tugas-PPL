...
import 'package:mobile_pssi/ui/scouting/controller/club_player_offerings.controller.dart';
import 'package:mobile_pssi/utils/ui.spacer.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';
import 'package:velocity_x/velocity_x.dart';

class OtherClubPlayerOffering extends GetView<ClubPlayerOfferingsController> {
  const OtherClubPlayerOffering({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    Get.put(ClubPlayerOfferingsController());
    return Obx(
      () => SmartRefresher(
        ...
        child: controller.offerings!.isEmpty
            ? const EmptyWithButton(
                emptyMessage: 'Tidak memiliki offering pemain dari klub lain.',
                showButton: false,
                showImage: true,
              )
            : ListView.builder(

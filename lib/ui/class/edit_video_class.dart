...
import 'package:mobile_pssi/ui/class/controller/edit_video.controller.dart';
import 'package:mobile_pssi/utils/ui.spacer.dart';
import 'package:multi_select_flutter/multi_select_flutter.dart';
import 'package:path/path.dart';
import 'package:velocity_x/velocity_x.dart';

class EditVideoClassScreen extends GetView<EditVideoController> {
  static const routeName = '/class/video/edit';
  const EditVideoClassScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultScaffold(
      ...
      title: 'Ubah Video'.text.make(),
      resizeToAvoidBottomInset: false,
      actions: [
        Obx(
          () => TextButton(
            onPressed:
                controller.isUploading.value ? null : controller.editVideo,
            child: 'Simpan'
                .text
                .color(
